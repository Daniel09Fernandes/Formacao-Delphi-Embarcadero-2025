...
uses
  ...
  System.IOUtils, Vcl.Graphics, Vcl.Imaging.GIFImg;
...
begin
  ...
  begin
    ...
    begin
      ...
      if tempIndx > -1 then
      begin
        var img: TGraphic := TClassificarImage.GetImage(FListaImagens[tempIndx]);
...
begin
  ...
  begin
    ...
    begin
      ...
      var lsImagensGif := TDirectory.GetFiles(FImagePath, '*.gif');
     // var lsImagensIco := TDirectory.GetFiles(FImagePath, '*.ico');
      ...
      FListaImagens.AddStrings(lsImagensGif);
