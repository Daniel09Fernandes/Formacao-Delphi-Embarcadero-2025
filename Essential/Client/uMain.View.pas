...
type
  ...
  private
   const
     ...
     CALL_API_DOLAR_REAL = '/ConverterDolarParaReal';
     CALL_API_REAL_DOLAR = '/ConverterRealParaDolar';
...
begin
  EdtRealResult.Text := ConsultaApi(CALL_API_DOLAR_REAL, EdtDolar.Text);
end;

procedure TForm2.BtnConvertRealClick(Sender: TObject);
begin
  EdtResultDolar.Text := ConsultaApi(CALL_API_REAL_DOLAR, EdtReal.Text);
end;
