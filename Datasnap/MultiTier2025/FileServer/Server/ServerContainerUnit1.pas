...
type
  TServerContainer1 = class(TDataModule)
    ...
    procedure DSServerFilesGetClass(DSServerClass: TDSServerClass;
      var PersistentClass: TPersistentClass);
    procedure DSServerBlockChainGetClass(DSServerClass: TDSServerClass;
      var PersistentClass: TPersistentClass);
  private
...
procedure TServerContainer1.DSServerBlockChainGetClass(
  DSServerClass: TDSServerClass; var PersistentClass: TPersistentClass);
begin
  PersistentClass := ServerMethodsBlockChain.TSMBlockChain;
end;
